...
- ### Learning & export model, labels
	...
	tfrecord/{--resize_int}_resized_{--image_dir}_train/ is created from the original directory, {--resize_int}_resized_{--image_dir}_train/. resized_{--image_dir}_train/ (specify "train").  
