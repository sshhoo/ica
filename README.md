...
This repository provides the source code to create the models used in [the TensorFlow Lite image classification application](https://www.tensorflow.org/lite/examples/image_classification/overview).  
